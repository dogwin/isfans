...
var App = function () {
    ...
    return {
        ...
        init: function () {
            ...
            $("#chose_user .modal-footer .btn.search").click(function(){
            	$.ajax({
            		url: site_url+"member_enter/ajax",type:"post",
            		dataType: "json",
            		data:"&account="+$("#chose_user #account").val()+'&xiaotangcai_csrf_test_name='+ getCookie('xiaotangcai_csrf_cookie_name'),
            		success: function(data){
            			console.log(data);
            			if(data.code==0){
            				$("#chose_user .modal-body .msg").html(data.msg);
            			}else{
            				$("#chose_user #account").val("");
            				console.log(data);
            				//alert(data.msg);
            ...
            $("#post_add .control-group #post_account").click(function(){
            	$("#post_chose_user_click").click();
            });
            $("#post_chose_user .modal-footer .btn.search").click(function(){
            	$.ajax({
            		url: site_url+"posts/ajax",type:"post",
            		dataType: "json",
            		data:"&tab=user&account="+$("#post_chose_user #search_account").val()+'&xiaotangcai_csrf_test_name='+ getCookie('xiaotangcai_csrf_cookie_name'),
            		success: function(data){
            			console.log(data);
            			if(data.code==0){
            				$("#post_chose_user .modal-body .msg").html(data.msg);
            			}else{
            				$("#post_chose_user #account").val("");
            				console.log(data);
            				//alert(data.msg);
            				$("#post_add .control-group #post_account").val(data.account);
            				$("#post_add .control-group #user_id").val(data.user_id);
            				$("#post_chose_user .modal-header .close").click();
            			}
