		...
		<div class="span12">
			...
			<div class="portlet box grey">
				...
				<div class="portlet-body form">
	            	<?php echo form_open('area_province/add', array('class' => 'form-horizontal', 'name' => 'basic_validate', 'id' => 'basic_validate')); ?>
	              	...
	              	<div class="control-group">
		                ...
		                <div class="controls">
		                  	<?php $this -> form -> show('name', 'input', ''); ?><label>*省份名称</label><?php echo form_error('name'); ?>
		                </div>
	              	</div>
