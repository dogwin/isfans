...
<div class="container-fluid">
	...
	$data_top['title'] = '修改帖子';
	$data_top['title_'] = '';
	$data_top['nav'][] = array('title' => '帖子管理', 'url' => 'post/view');
	$data_top['nav'][] = array('title' => '修改帖子');
	?>
		...
		<div class="span12">
			...
			<div class="portlet box grey">
				<div class="portlet-title">
					<div class="caption">
						<i class="icon-reorder"></i>修改帖子
					</div>
					<div class="tools"></div>
				</div>
				<div id="post_add" class="portlet-body form">
					<?php echo form_open('posts/edit/'.$info->id, array('class' => 'form-horizontal', 'name' => 'basic_validate','enctype'=>"multipart/form-data", 'id' => 'basic_validate')); ?>
					<div class="control-group">
						<label class="control-label">用户名</label>
						<div class="controls">
							<a id="post_chose_user_click" data-toggle="modal" href="#post_chose_user"></a>
							<input id="post_account" class="normal" type="text" name="account" value='<?= $account?>' />
							<input id="user_id" class="normal" type="hidden" name="user_id" value='<?= $user_id?>' />
							<label></label>
						</div>
					</div>
					<div class="control-group">
					...
					<div class="control-group">
						...
						<div class="controls">
							<?php $this->form->show('postTitle', 'input','', $postTitle); ?>
					...
					<div class="control-group">
						...
						<div class="controls">
							<?php $this -> form -> show('postContent', 'textarea','', $postContent); ?>
					...
					<div class="control-group">
						...
						<div class="controls">
							<?php $this->form->show('lng', 'input', '', $lng); ?>
					...
					<div class="control-group">
						...
						<div class="controls">
							<?php $this->form->show('lat', 'input', '', $lat); ?>
					...
					<div class="control-group">
						...
						<div class="controls">
							<?php $this->form->show('hits', 'input', '', $hits); ?>
							<label>*点击量.</label><?php echo form_error('lat'); ?>
						</div>
					</div>
					<div class="control-group">
