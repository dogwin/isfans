...
class Platform
{
    ...
    private function _init($running_platform)
    {
        ...
        {
            if (file_exists(HC_JY_SHARE_PATH . 'config/platform.php'))
            {
               include HC_JY_SHARE_PATH . 'config/platform.php';
            }
        }
        ...
        if (file_exists($platform_class_path = HC_JY_SHARE_PATH . 'libraries/platforms/platform_' . $platform . '.php'))
        {
