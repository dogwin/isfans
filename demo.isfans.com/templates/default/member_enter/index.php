...
<div class="container-fluid">
	...
	$data_top = array();
	$data_top['title'] = '企业管理';
	$data_top['title_'] = '管理企业会员';
	$data_top['nav'][] = array('title' => '企业会员管理');
	?>
		...
		<div class="span12">
			...
			<div class="portlet box grey">
          		<div class="portlet-title">
					<div class="caption"><i class="icon-globe"></i>企业会员列表</div>
					<div class="actions">
						<a class="btn blue" data-toggle="modal" href="#chose_user"><i class="icon-pencil"></i>添加企业会员</a>
          		...
          		<div class="portlet-body">
	          		<form style="margin:0" action="<?= base_url() ?>member_enter/view" method="post" name="forms">
            		...
            		<table class="table table-striped table-bordered table-hover" >
              			...
              			<tbody>
			                ...
			                <tr class="odd gradeX">
		                  		...
		                  		<td>
						  			<a class="" href="<?php echo backend_url('member_enter/edit/' . $v -> id);
									echo $pu;
								?>"><span class="label label-success">修改</span></a>
									<?php if($v->active==1){?>
		                    		<a class="confirm_delete" href="<?php echo backend_url('member_enter/active/' . $v->id); ?>"><span class="label label-success">禁用</span></a>
						  			<?php }else{?>
						  			<a class="confirm_delete" href="<?php echo backend_url('member_enter/active/' . $v->id); ?>/1"><span class="label label-success">开启</span></a>
						  			<?php }?>
						  			<a class="confirm_delete" href="<?php echo backend_url('member_enter/examine/' . $v->id); ?>"><span class="label label-success">审核</span></a>
						  		</td>
                			</tr>
                			<?php endforeach; ?>
              			</tbody>
