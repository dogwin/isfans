		...
		<div class="span12">
			...
			<div class="portlet box grey">
				<div class="portlet-title">
					<div class="caption">
						<i class="icon-reorder"></i>添加国家
					</div>
					<div class="tools"></div>
				</div>
				<div class="portlet-body form">
	            	<?php echo form_open('area_country/add', array('class' => 'form-horizontal', 'name' => 'basic_validate', 'id' => 'basic_validate')); ?>
	              	<div class="control-group">
		                <label class="control-label">国家名称</label>
		                <div class="controls">
		                  	<?php $this -> form -> show('name', 'input', ''); ?><label>*国家名称</label><?php echo form_error('name'); ?>
		                </div>
	              	</div>
